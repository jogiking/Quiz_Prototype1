...
class QuizCVCell: UICollectionViewCell {
    ...
    var question: Question? {
        didSet {
            ...
            imgView.image = UIImage(systemName: unwrappedQue.imgName)
    ...
    func setupViews() {
        ...
        addSubview(btn1)
        NSLayoutConstraint.activate([btn1.topAnchor.constraint(equalTo: lblQue.bottomAnchor, constant: 20),
        ...
        NSLayoutConstraint.activate([btn2.topAnchor.constraint(equalTo: btn1.topAnchor),
                                     ...
                                     btn2.widthAnchor.constraint(equalToConstant: btnWidth), btn2.heightAnchor.constraint(equalToConstant: btnHeight)
                                    ])
        ...
        NSLayoutConstraint.activate([btn3.topAnchor.constraint(equalTo: btn1.bottomAnchor, constant: 20),
                                     btn3.rightAnchor.constraint(equalTo: self.centerXAnchor, constant: -10), btn3.widthAnchor.constraint(equalToConstant: btnWidth),
    ...
    let imgView: UIImageView = {
        let v=UIImageView()
        v.image = UIImage(systemName: "circle")
